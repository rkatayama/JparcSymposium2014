...
class UCNPhysicsList: public G4VUserPhysicsList
{
	...
	public:   
		...
		UCNMaterialBoundary* GetUCNMaterialBoundary(){
			return theMaterialBoundary;
		}
	...
	private:
		...
		//add by katayama
		//////////////////////
		UCNMaterialBoundary* theMaterialBoundary;
		UCNSimpleAbsorption* theSimpleAbsorption;
		UCNSimpleLoss* theSimpleLoss;
		UCNMultiScattering* theMultiScattering;
		UCNSpin* theSpin;
		UCNDetector* theDetector;
		G4Decay* theDecayProcess;
		UCNTimeStopStep* theTimeStopStep;
		//////////////////////
