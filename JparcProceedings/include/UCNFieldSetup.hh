...
public:
 ...
 ~UCNFieldSetup() ;  
  ...
  G4ThreeVector GetConstantFieldValue();
	...
	//add by katayama
	////////////////////
	void SetEFieldDirection(G4int newValue){
		EFieldDirection = newValue;
		G4cout<<"EFieldDirection="<<EFieldDirection<<G4endl;
	}

	void SetGravityEffect(G4int newValue){
		GravityEffect = newValue;
		G4cout<<"GravityEffect="<<GravityEffect<<G4endl;
	}

	G4int GetEFieldDirection(){
		return EFieldDirection;
	}

	G4int GetGravityEffect(){
